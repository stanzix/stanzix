...
const TABS: Tab[] = [
  {
    ...
    prompt: [
      ...
      { label: "PRIORITY", value: "Security issues override style" },
  ...
  },
  {
    ...
    prompt: [
      ...
      { label: "SAFETY", value: "Flag unverified assumptions" },
  ...
  },
  {
    ...
    prompt: [
      ...
      { label: "BEHAVIOR", value: "Analysis mode" },
      { label: "PRIORITY", value: "Accuracy over synthesis speed" },
      { label: "SAFETY", value: "Flag assumptions, cite sources" },
      { label: "FORMAT", value: "Structured findings, citable" },
      { label: "EXAMPLES", value: "Published qualitative studies" },
    ],
  },
];
