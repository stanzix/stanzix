  ...
  return (
    <div style={{ marginTop: "10px", background: "rgba(192,122,86,0.04)", border: "1px solid rgba(192,122,86,0.2)", borderRadius: "10px", padding: "14px 16px" }}>
      ...
      {suggestion.alternatives?.length > 0 && (
        <div style={{ marginBottom: "10px" }}>
          <div style={{ fontSize: "10px", fontFamily: "'IBM Plex Mono', monospace", color: "rgba(255,255,255,0.55)", textTransform: "uppercase", letterSpacing: "1px", marginBottom: "6px", fontWeight: 600 }}>Alternatives</div>
      ...
      {suggestion.missingInfo?.length > 0 && (
        <div style={{ marginTop: "8px", borderTop: "1px solid rgba(255,255,255,0.06)", paddingTop: "8px" }}>
          <div style={{ fontSize: "10px", fontFamily: "'IBM Plex Mono', monospace", color: "rgba(208,80,80,0.7)", textTransform: "uppercase", letterSpacing: "1px", marginBottom: "6px", fontWeight: 600 }}>You Might Be Missing</div>
          {suggestion.missingInfo.map((info, i) => <div key={i} style={{ fontSize: "12px", color: "rgba(255,255,255,0.5)", padding: "4px 0", display: "flex", gap: "6px" }}><span style={{ color: "rgba(208,80,80,0.5)" }}>?</span> {info}</div>)}
        </div>
      )}
    </div>
  );
